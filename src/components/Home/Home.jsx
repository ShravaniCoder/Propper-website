...
import Background2 from "../../assets/bg-01.jpg";
import Image1 from "../../assets/icon-white-shield.png";
import Image2 from "../../assets/icon-white-pin.png";
import Image3 from "../../assets/icon-white-wallet.png";
    ...
    <>
      ...
      <div className="relative">
        <img
          src={Background2}
          alt="Background2"
          className="h-64 w-full bg-black bg-opacity-70 object-cover"
        />
        <div className="bg-black bg-opacity-70 absolute inset-0" />

        <div className="absolute top-10 left-0 right-0 flex justify-between px-[200px]">
          <div className="flex-col items-center mr-20">
            <img
              src={Image1}
              alt="Shield"
              className="w-15 h-15 mr-4 absolute"
            />
            <h1 className="text-white font-bold text-lg mb-4 mt-9 ml-14">
              Modern & Safe Living
            </h1>
            <h5 className="text-white text-xs ml-14">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris ac
              ornare felis. Nam velit neque, blandit id placerat
            </h5>
            <button className="bg-white text-black p-2 items-center mt-4 rounded-full text-xs font-medium flex ml-14">
              READ MORE
          ...
          <div className="flex-col items-center mr-20">
            ...
            <button className="bg-white text-black items-center p-2 mt-4 ml-14 rounded-full text-xs font-medium flex">
              READ MORE
              <FaArrowRight className="ml-2 font-xl font-light" />
            </button>
          </div>
          <div className="flex-col items-center">
            ...
            <button className="bg-white text-black items-center p-2 mt-5 ml-14 rounded-full text-xs font-medium flex">
              READ MORE
              <FaArrowRight className="ml-2 font-xl font-light" />
            </button>
          </div>
